<template>
  <svg
    ...
    y="0px"
    width="165.506px"
    viewBox="0 0 165.506 363.921"
    enable-background="new 0 0 165.506 363.921"
    xml:space="preserve"
  >
    <g>
      <path
        fill="current"
        d="M82.752,44.559C37.049,44.559,0,81.609,0,127.312c0,113.52,82.752,206.883,82.752,206.883
      ...
      <path
        fill="current"
        d="M117.764,122.008H92.903c-1.082-2.07-2.775-3.764-4.846-4.847V82.753c0-2.93-2.375-5.304-5.305-5.304
      ...
      />
      <ellipse fill="current" cx="82.753" cy="18.566" rx="29.706" ry="18.566" />
      <path
        fill="current"
        d="M29.623,273.742l22.545,35.227c0,0-32.408,23.953-35.227,54.953
		C16.941,363.921-12.648,323.058,29.623,273.742z"
      />
      <path
        fill="#FFFFFF"
        d="M135.879,273.742l-22.543,35.227c0,0,32.408,23.953,35.225,54.953
