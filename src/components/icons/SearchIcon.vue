<template>
  <svg
    ...
    width="33.676px"
    height="38.271px"
    viewBox="591.605 401.648 33.676 38.271"
    enable-background="new 591.605 401.648 33.676 38.271"
    xml:space="preserve"
  >
    <path
      fill="current"
      d="M625.281,437.649l-10.627-14.084c2.116-2.346,3.418-5.442,3.418-8.844c0-7.297-5.937-13.233-13.233-13.233
